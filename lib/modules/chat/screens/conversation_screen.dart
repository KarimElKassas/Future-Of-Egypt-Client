...
import 'package:future_of_egypt_client/shared/audio_widget_chat.dart';
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Container(
                ...
                child: cubit.chatListReversed[index].senderID == cubit.userID
                    ? AudioWidgetChat(url: '/storage/emulated/0/Download/Future Of Egypt Media Client/Records/${cubit.chatListReversed[index].fileName}', cubit: cubit, index: index,)
                    : Row(
                  children: [
                    const SizedBox(
                      width: 8.0,
