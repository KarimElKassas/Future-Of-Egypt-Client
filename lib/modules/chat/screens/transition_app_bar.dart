...
class TransitionAppBar extends StatelessWidget {
  ...
  const TransitionAppBar({this.avatar, this.title, this.extent = 250, Key? key})
      : super(key: key);
          ...
          child: Align(
            ...
            child:Column(
              ...
              children: [
                ...
                Text("mazenelgamal26@gmail.com",style: const TextStyle(color: Colors.grey,fontSize: 14),),
              ],
            ),
          ),
        ),
