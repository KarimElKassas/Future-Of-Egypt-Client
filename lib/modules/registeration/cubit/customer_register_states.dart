...
class CustomerRegisterAddLoginDataSuccessState extends CustomerRegisterStates{}
...
class CustomerRegisterAddLoginDataErrorState extends CustomerRegisterStates{

  final String error;

  CustomerRegisterAddLoginDataErrorState(this.error);
